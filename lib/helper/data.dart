...
List<CategoryModal> getCategory(){

  List<CategoryModal> myCategories = new List<CategoryModal>();
  CategoryModal categorieModel;

  //1
  categorieModel = new CategoryModal();
  categorieModel.categorieName = "Business";
  categorieModel.imageAssetUrl = "https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80";
